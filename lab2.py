...
print('The words start with letter "e":')

for x in words:
    if x[0] == 'e':
        print(x)
print("*******************************************************")
print('The words start with letters "ha" :')
...
maxAst = int(input("Enter number between 3 and 9(inclusive):"))
if 3 <= maxAst <= 9:
    for i in range(maxAst + 1):
        print(i * "*")
    for i in reversed(range(maxAst)):
        print(i * "*")
else:
    print("number is not in range of 3-9")
